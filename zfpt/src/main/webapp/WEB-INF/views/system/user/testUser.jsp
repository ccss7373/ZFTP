...
<span id="addSpan">
 <fieldset>
  ...
  <form id="addForm" name="addForm" class="form-horizontal" method="post" action="">	 
    ...
    <label class="col-sm-3 control-label">登录密码</label><input type="password" class="form-control checkacc" placeholder="请输入密码" name="userPassword" id="userPassword">
    <label class="col-sm-3 control-label">邮箱</label><input type="text" class="form-control checkacc" placeholder="请输入邮箱" name="email" id="email">
